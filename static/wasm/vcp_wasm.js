 ...
 * @returns {string}
 */
export function encode_context_wire(obj) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.encode_context_wire(obj);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {string}
 */
export function encode_csm1(obj) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.encode_csm1(obj);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {string}
 */
export function encode_csm1_token(obj) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.encode_csm1_token(obj);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {any}
 */
export function parse_context_wire(wire) {
    const ptr0 = passStringToWasm0(wire, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_context_wire(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function parse_csm1(code) {
    const ptr0 = passStringToWasm0(code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_csm1(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function parse_csm1_token(token) {
    const ptr0 = passStringToWasm0(token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_csm1_token(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
export function validate_token(token) {
    const ptr0 = passStringToWasm0(token, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_token(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vcp_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
